        ...
        Profile
          ...
          <div className="max-w-2xl mx-auto py-24 px-4 grid items-center grid-cols-1 gap-y-16 gap-x-8 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8 lg:grid-cols-3 ">
            ...
            <h2 className="font-medium tracking-tight text-gray-900 sm:text-1xl b">
                ...
                <b>https://github.com/ShivaaniDushya/MAD-Y2S2</b>
            </h2>
            </a>
            </div>
            ...
            <h2 className="font-medium tracking-tight text-gray-900 sm:text-1xl b">
                ...
                teachers due to covid 19 situation. We used Spring Boot and H2 Database for the backend implementation.<br/><br/>
                <b>https://github.com/miyurugunarathna/aspire-backend</b>
            </h2>
            </a>
            </div>
            ...
            <h2 className="font-medium tracking-tight text-gray-900 sm:text-1xl b">
                ...
                <b>https://github.com/miyurugunarathna/aspire-frontend</b>
            </h2>
            </a>
            </div>
