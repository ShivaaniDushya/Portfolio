    ...
    <div className="bg-sky-100 dark:bg-slate-900">
      <div className="max-w-2xl mx-auto py-24 px-4 grid items-center grid-cols-1 gap-y-16 gap-x-8 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8 lg:grid-cols-2">
        ...
        <div className="grid grid-cols-1 grid-rows-1 gap-4 sm:gap-6 lg:gap-8">
          ...
          <img
            src="./images/speaking/playwright.png"
            alt="Shivaani Dushya"
        ...
        <div>
          ...
          <a href="https://youtu.be/N7vax4qm7og">
        ...
        <div>
          ...
          <a href="https://youtu.be/_-i8p54OaGM?list=PLM1HdceeXpsOqJTw1GVzIOqrLyrg_xDTu">
            <button class="bg-white dark:bg-gray-300 hover:bg-gray-100 text-gray-800 font-medium py-2 px-2 border border-gray-400 rounded shadow sm:text-sm">
              Video Link
            </button>
          </a>
        ...
        <div className="grid grid-cols-1 grid-rows-1 gap-4 sm:gap-6 lg:gap-8">
          ...
          <img
            src="./images/speaking/session2itp.jpg"
            alt="Shivaani Dushya"
            className="bg-gray-100 rounded-lg"
            width={1000}
            height={1000}
        ...
        <div>
          ...
          <a href="https://youtu.be/-LaIxxxIEmY">
            <button class="bg-white dark:bg-gray-300 hover:bg-gray-100 text-gray-800 font-medium py-2 px-2 border border-gray-400 rounded shadow sm:text-sm">
              Video Link
            </button>
          </a>
